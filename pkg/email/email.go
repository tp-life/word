...
type (
	...
	config struct {
		Username string `mapstructure:"username" toml:"username" env:"EMAIL_USER"`
		Password string `mapstructure:"password" toml:"password" env:"EMAIL_PASS"`
		Host     string `mapstructure:"host" toml:"host" env:"EMAIL_HOST"`
		Ssl      bool   `mapstructure:"ssl" toml:"ssl" env:"EMAIL_SSL`
		Port     int    `mapstructure:"port" toml:"port" env:"EMAIL_PORT"`
	}
)
