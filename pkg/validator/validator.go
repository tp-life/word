...
var (
	...
	_                   = app.NewConfig("validator-messages.yaml").Unmarshal(&validatorMessages)
	enUs                = en.New()
	zhCn                = zh.New()
...
func Bind(c *gin.Context, param interface{}) *ValidErrors {
	...
	if err != nil {
		...
		if ok {
			...
			validErrors.add("whole", "params error, please check your JavaScript code or Json content")
		}
	}
	return validErrors
}
